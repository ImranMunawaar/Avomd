...
export class CalculatorReport extends Component {
  render() {
    const { associatedCalculator, calculatorResult, classes } = this.props;
    const outputCatgeory = calculatorResult?.validCategoricalOutput;
      ...
      <View>
        {isValid(calculatorResult) && (
          ...
          >
            ...
            >
              ...
              {isValid(calculatorResult.calculatedValue, true) && (
                ...
                >
                  ...
                  {isValid(calculatorResult.numerical?.unit) &&
                    " " + calculatorResult.numerical.unit}
                </Text>
              )}
            </View>
            <View
            ...
            />
            <ScrollView style={{ maxHeight: getHeight(250) }}>
              {outputCatgeory && (
                <>
                  <View
                    style={{
